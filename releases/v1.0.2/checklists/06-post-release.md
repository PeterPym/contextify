...
- [ ] New release notes page created? `website/release-notes/1.0.2.html`
- [ ] Required updates: ____
...
cat dist/Contextify-1.0.2.dmg.sha256

# Download and hash the public DMG
curl -sL "https://github.com/PeterPym/contextify/releases/download/v1.0.2/Contextify-1.0.2.dmg" | shasum -a 256
```
...
- [ ] Ensure `releases/v1.0.2/` is complete
...
### Git Housekeeping
- [ ] Release tag exists: `git tag -l v1.0.2`
...
**Version:** 1.0.2
**Released:** ____
**DMG:** https://github.com/banagale/contextify/releases/tag/v1.0.2
