...
- [ ] Save to: `releases/v1.0.2/assets/submission-screenshot.png`

## Record Submission

```bash
# Record in tracking system
./scripts/release/mark-submitted.sh 1.0.2 --build ____
```
...
- [ ] Record rejection:
  ```bash
  ./scripts/release/mark-rejected.sh 1.0.2 --interactive
  ```
- [ ] Determine fix:
