...
- [ ] Save to: `releases/v1.0.6/assets/submission-screenshot.png`

## Record Submission

```bash
# Record in tracking system
./scripts/release/mark-submitted.sh 1.0.6 --build ____
```
