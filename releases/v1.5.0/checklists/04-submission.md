...
- [ ] Save to: `releases/v1.5.0/assets/submission-screenshot.png`

## Snapshot Metadata

Preserve the metadata submitted for this version:
```bash
cp appstore-metadata/metadata.json releases/v1.5.0/metadata.json
```
...
./scripts/release/mark-submitted.sh 1.5.0 --build ____
```
