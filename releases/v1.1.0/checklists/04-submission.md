...
- [ ] Save to: `releases/v1.1.0/assets/submission-screenshot.png`

## Record Submission

```bash
# Record in tracking system
./scripts/release/mark-submitted.sh 1.1.0 --build ____
```
