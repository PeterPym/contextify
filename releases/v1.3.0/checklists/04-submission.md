...
- [ ] Save to: `releases/v1.3.0/assets/submission-screenshot.png`

## Record Submission

```bash
# Record in tracking system
./scripts/release/mark-submitted.sh 1.3.0 --build ____
```
