...
```bash
mkdir -p releases/v1.3.1/changelog
cp /tmp/*-release-analysis.md releases/v1.3.1/changelog/internal-analysis.md
cp /tmp/*-release-notes-external.md releases/v1.3.1/changelog/external-notes.md
```

- [ ] Internal analysis saved: `releases/v1.3.1/changelog/internal-analysis.md`
- [ ] External notes saved: `releases/v1.3.1/changelog/external-notes.md`
...
- [ ] Launch archived app: `open build/archives/v1.3.1/appstore/Contextify.xcarchive/Products/Applications/Contextify.app`
