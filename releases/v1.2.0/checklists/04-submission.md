...
- [x] Parse `appstore-metadata/metadata.json` - source of truth
- [ ] System requirements still accurate?
- [ ] Feature list reflects current capabilities?
- [x] What's New text updated for this version?
...
```
- [x] Metadata uploaded (or no changes needed)
...
- [ ] Save to: `releases/v1.2.0/assets/submission-screenshot.png`

## Record Submission

```bash
# Record in tracking system
./scripts/release/mark-submitted.sh 1.2.0 --build ____
```
