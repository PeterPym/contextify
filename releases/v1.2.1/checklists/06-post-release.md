...
- [ ] New release notes page created? `website/release-notes/1.2.1.html`
...
cat dist/Contextify-1.2.1.dmg.sha256

# Download and hash the public DMG
curl -sL "https://github.com/PeterPym/contextify/releases/download/v1.2.1/Contextify-1.2.1.dmg" | shasum -a 256
```
...
curl -sL "https://github.com/PeterPym/contextify/releases/download/v1.2.1/Contextify-1.2.1.dmg" -o /tmp/verify.dmg
...
curl -s https://contextify.sh/appcast.xml | grep -A5 "Version 1.2.1" | grep "sparkle:version"
...
- [ ] Ensure `releases/v1.2.1/` is complete
...
### Git Housekeeping
- [ ] Release tag exists: `git tag -l v1.2.1`
...
**Version:** 1.2.1
**Released:** ____
**DMG:** https://github.com/banagale/contextify/releases/tag/v1.2.1
