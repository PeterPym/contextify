...
final class TranscriptParserTests: XCTestCase {
  ...
  func testToolResultMatchesKnownToolUse() throws {
    ...
    let userLine = """
    {"type":"user","uuid":"user-1","timestamp":"2025-11-16T12:00:01Z","message":{"content":[{"type":"tool_result","tool_use_id":"toolu_123","content":"ok"}]}}
    """
  ...
  func testToolResultMissingToolUseIncrementsMetric() throws {
    ...
    let userLine = """
    {"type":"user","uuid":"user-2","timestamp":"2025-11-16T12:00:05Z","message":{"content":[{"type":"tool_result","tool_use_id":"toolu_missing","content":"stderr"}]}}
    """
