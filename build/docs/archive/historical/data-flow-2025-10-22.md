...
6. Update allSessions for transcripts
...
## The Gap: Transcripts Window

### Comparison: Working vs Broken

| Aspect | Main Timeline (Working ✅) | Transcripts (Broken ⚠️) |
|--------|---------------------------|----------------------------------|
...
3. **Data Integrity**:
   - Transcripts shows sessions that don't exist in `transcripts` table
...
The **transcripts window has a known gap**:
