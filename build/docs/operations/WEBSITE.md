...
The cloud API (cloud.contextify.sh) runs on a **separate, dedicated server**, not on this droplet. See [CLOUD-SERVER.md](CLOUD-SERVER.md) for full documentation and [INFRASTRUCTURE.md](INFRASTRUCTURE.md) for the relationship between servers.
