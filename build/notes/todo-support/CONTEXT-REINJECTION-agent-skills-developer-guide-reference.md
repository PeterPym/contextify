...
title: Reference - Agent Skills developer guide (Claude Code)
type: reference
date: 2025-12-12
status: active
description: Local copy of the Agent Skills developer guide for Claude Code, used to implement Phase 2 skill distribution and validation.
source_path: /private/tmp/agent-skills-developer-guide.md
---
# Agent Skills
