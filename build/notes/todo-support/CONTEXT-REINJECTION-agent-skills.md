...
title: Reference - Agent Skills (overview)
type: reference
date: 2025-12-12
status: active
description: Local copy of the Agent Skills overview documentation for Phase 2 (skills-first adoption).
source_path: /private/tmp/agent-skills.md
---
# Agent Skills
