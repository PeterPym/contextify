---
todo_id: P2-SWITCH
title: Project Switch Consolidation - Source Code Analysis
type: source_analysis
date: 2025-11-16
status: reference
description: Complete source code package for validating project switch consolidation plan
---

# Project Switch Consolidation - Source Code Package

**Date:** 2025-11-16
**Purpose:** Complete source code for validating the consolidation plan
**Total Lines:** ~3,762 lines (3 files)

---

## TABLE OF CONTENTS

1. [ConversationMonitor.swift](#conversationmonitor) - Main file containing all 4 project switch paths (~2,980 lines)
2. [StartupCoordinator.swift](#startupcoordinator) - Coordinator that triggers Path 3 (~664 lines)
3. [ActiveProjectContext.swift](#activeprojectcontext) - Project identity model (~118 lines)

---

## Key Locations Referenced in Plan

### Path 1: `startMonitoring()` Initial Load
- **File:** ConversationMonitor.swift
- **Line:** ~608
- **What:** Loads initial feed on monitoring start

### Path 2: `onProjectOrSessionChange()` Load
- **File:** ConversationMonitor.swift
- **Line:** ~755
- **What:** Triggered by `didSet` on `currentProjectId` or `currentSessionId`

### Path 3: `handleContextUpdate()` via StartupCoordinator
- **File:** ConversationMonitor.swift
- **Line:** ~908
- **What:** Receives updates from StartupCoordinator.shared.updates()

### Path 4: Legacy `.projectRootDidChange` Notification
- **File:** ConversationMonitor.swift
- **Line:** ~922-941
- **What:** Handles legacy notification, delegates to Path 3

---
---
---

<a name="conversationmonitor"></a>
# FILE 1: ConversationMonitor.swift

**Path:** `Contextify/Contextify/ConversationMonitor.swift`
**Lines:** ~2,980
**Purpose:** Main timeline monitoring component containing all 4 project switch code paths
...
<a name="startupcoordinator"></a>
# FILE 2: StartupCoordinator.swift

**Path:** `app/Sources/ContextifyCore/Coordination/StartupCoordinator.swift`
**Lines:** ~664
**Purpose:** Coordinates app startup and emits ActiveProjectContext updates (triggers Path 3)
...
<a name="activeprojectcontext"></a>
# FILE 3: ActiveProjectContext.swift

**Path:** `app/Sources/ContextifyCore/Models/ActiveProjectContext.swift`
**Lines:** ~118
**Purpose:** Data model representing active project identity (use .id for all queries)
...
# END OF SOURCE CODE PACKAGE

**Summary:**
- 3 Swift source files included
- Total: ~3,762 lines of code
- All 4 project switch paths are in ConversationMonitor.swift
- StartupCoordinator triggers Path 3
- ActiveProjectContext provides the data model

**Related Documentation:**
- Consolidation plan: `/tmp/project-switch-consolidation-plan-STREAMLINED.md`
- Complete analysis: `/tmp/project-switch-consolidation-COMPLETE.md`

---

*Generated 2025-11-16 for project switch consolidation validation*
