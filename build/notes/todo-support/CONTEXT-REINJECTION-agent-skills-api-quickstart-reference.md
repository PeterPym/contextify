...
title: Reference - Agent Skills API quickstart
type: reference
date: 2025-12-12
status: active
description: Local copy of the Agent Skills API quickstart tutorial, used as background for skills packaging and distribution.
source_path: /private/tmp/get-started-with-agent-skills-in-api.md
---
